...
//     $host = parse_url($url)["host"]; // www.mustafaomari.com
...
//         $src = $scheme . "://" . $host . "/" . $src;
//     }
//     elseif(substr($src, 0, 4) != "http" && substr($src, 0, 5) != "https"){
//         $src = $scheme . "://" . $host . "/" . $src;
//     }
...
//     $titleArray = $parser->getTitleTags(); // i thing i should say tags
...
// $startUrl = "http://www.airbnb.com";
// return followLinks($startUrl);
...
$startUrl = "https://www.netflix.com/jo-en/";
